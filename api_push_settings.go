...
type ApiDeletePushPlatformsRequest struct {
	ctx context.Context
	ApiService *PushSettingsAPIService
	platformId string
}

func (r ApiDeletePushPlatformsRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeletePushPlatformsExecute(r)
}

/*
DeletePushPlatforms Delete a Push Notification Platform

To delete a push notification platform in your workspace.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param platformId The ID of the Platform
 @return ApiDeletePushPlatformsRequest
*/
func (a *PushSettingsAPIService) DeletePushPlatforms(ctx context.Context, platformId string) ApiDeletePushPlatformsRequest {
	return ApiDeletePushPlatformsRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
func (a *PushSettingsAPIService) DeletePushPlatformsExecute(r ApiDeletePushPlatformsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PushSettingsAPIService.DeletePushPlatforms")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/push/platforms/{platform_id}"
...
type ApiGetPushPlatformRequest struct {
	ctx context.Context
	ApiService *PushSettingsAPIService
	platformId string
}

func (r ApiGetPushPlatformRequest) Execute() (*PushPlatformResponse, *http.Response, error) {
	return r.ApiService.GetPushPlatformExecute(r)
}

/*
GetPushPlatform Retrieve an Existing Push Notification Platform

To get details about a specific push notification platform in your workspace.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param platformId The ID of the Platform
 @return ApiGetPushPlatformRequest
*/
func (a *PushSettingsAPIService) GetPushPlatform(ctx context.Context, platformId string) ApiGetPushPlatformRequest {
	return ApiGetPushPlatformRequest{
		ApiService: a,
		ctx: ctx,
		platformId: platformId,
...
// Execute executes the request
//  @return PushPlatformResponse
func (a *PushSettingsAPIService) GetPushPlatformExecute(r ApiGetPushPlatformRequest) (*PushPlatformResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PushSettingsAPIService.GetPushPlatform")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdatePushPlatformRequest struct {
	ctx context.Context
	ApiService *PushSettingsAPIService
	platformId string
	pushPlatformRequest *PushPlatformRequest
...
func (r ApiUpdatePushPlatformRequest) PushPlatformRequest(pushPlatformRequest PushPlatformRequest) ApiUpdatePushPlatformRequest {
	r.pushPlatformRequest = &pushPlatformRequest
	return r
}

func (r ApiUpdatePushPlatformRequest) Execute() (*PushPlatformResponse, *http.Response, error) {
	return r.ApiService.UpdatePushPlatformExecute(r)
}

/*
UpdatePushPlatform Update a Push Notification Platform

To update details about a specific push notification platform in your workspace.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param platformId The ID of the Platform
 @return ApiUpdatePushPlatformRequest
*/
func (a *PushSettingsAPIService) UpdatePushPlatform(ctx context.Context, platformId string) ApiUpdatePushPlatformRequest {
	return ApiUpdatePushPlatformRequest{
		ApiService: a,
		ctx: ctx,
		platformId: platformId,
...
// Execute executes the request
//  @return PushPlatformResponse
func (a *PushSettingsAPIService) UpdatePushPlatformExecute(r ApiUpdatePushPlatformRequest) (*PushPlatformResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PushSettingsAPIService.UpdatePushPlatform")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
