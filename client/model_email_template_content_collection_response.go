...
// checks if the EmailTemplateContentCollectionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailTemplateContentCollectionResponse{}

// EmailTemplateContentCollectionResponse struct for EmailTemplateContentCollectionResponse
type EmailTemplateContentCollectionResponse struct {
...
func NewEmailTemplateContentCollectionResponse() *EmailTemplateContentCollectionResponse {
	this := EmailTemplateContentCollectionResponse{}
	return &this
}
...
func (o EmailTemplateContentCollectionResponse) MarshalJSON() ([]byte, error) {
...
func (o EmailTemplateContentCollectionResponse) ToMap() (map[string]interface{}, error) {
...
type NullableEmailTemplateContentCollectionResponse struct {
	value *EmailTemplateContentCollectionResponse
	isSet bool
}

func (v NullableEmailTemplateContentCollectionResponse) Get() *EmailTemplateContentCollectionResponse {
	return v.value
}

func (v *NullableEmailTemplateContentCollectionResponse) Set(val *EmailTemplateContentCollectionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEmailTemplateContentCollectionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEmailTemplateContentCollectionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmailTemplateContentCollectionResponse(val *EmailTemplateContentCollectionResponse) *NullableEmailTemplateContentCollectionResponse {
	return &NullableEmailTemplateContentCollectionResponse{value: val, isSet: true}
}

func (v NullableEmailTemplateContentCollectionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmailTemplateContentCollectionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
